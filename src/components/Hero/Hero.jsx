...
const Hero = ({ handleOrderPopup }) => {
  ...
  return (
    <div className="relative overflow-hidden min-h-[550px] sm:min-h-[650px] bg-gray-100 flex justify-center items-center dark:bg-gray-950 dark:text-white transition duration-200">
      {/* Background pattern */}
                ...
                <div className="flex flex-col justify-center gap-4 pt-12 sm:pt-0 text-center sm:text-left order-2 sm:order-1 relative z-10">
                  ...
                  >
                    <button
                      ...
                      className="bg-gradient-to-r from-primary to-secondary hover:scale-105 transition-transform duration-200 text-white py-2 px-4 rounded-full shadow-lg"
                    >
                      Order Now
                    </button>
                  </div>
